                ...
                <div class="container-fluid"> 
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="menu">
                                <ul>
                                    <li><a href="#" class="active">Poster <span>8</span></a></li>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="tImgsD">
                                                    <span>
                                                        <img src="assets/img/avater.png" alt="">
                                                        <a href="#"><img src="assets/img/icons/download.png" alt=""></a>
                                                    </span> 
                                                    <span>
                                                        <img src="assets/img/avater.png" alt="">
                                                        <a href="#"><img src="assets/img/icons/download.png" alt=""></a>
                                            ...
                                            <td>8x10-Daisy</td>
                                            <td>Black</td>
                                            <td><span class="sts success">Submit</span></td> 
                                        </tr> 
                                        <tr>
                                            <td>Marvin McKinney</td>
                                            <td>4</td>
                                            ...
                                            <td>8x10-Daisy</td>
                                            <td>Black</td>
                                            <td><span class="sts">Done</span></td> 
                                        </tr>  
                                        <tr>
                                            <td>Marvin McKinney</td>
                                            <td>4</td>
